...
" This particular requires the terminal palette
set bg&
hi clear Normal
hi clear SpecialKey
hi clear
...
fun! g:HandleOtherColors()
    ...
    hi Todo                       ctermfg=143  ctermbg=NONE cterm=bold,inverse
    hi Constant                   ctermfg=0    ctermbg=NONE cterm=bold
    "red group
    "Acceptable red colors    :: c160,c161,c196,c197
