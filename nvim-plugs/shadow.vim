...
let g:theme=0
let g:colorList=[[231,232,234,236,238,240,242,],
            \    [232,231,254,255,252,251,250,]]
let g:accentColor=70
let g:offColor=141
let g:backcentColor=60
let g:modColor=40
let g:backModColor=22
let g:selectColor=197
...
fun! g:HandleBackgroundColors()
    ...
    exec printf("hi SearchNC ctermfg=NONE ctermbg=%d cterm=underline"  , g:colorList[g:theme][6])
endfun
...
fun! g:HandleAccentColors()
    exec printf("hi LineNr ctermfg=%d ctermbg=NONE cterm=bold"        , g:normalColor)
    exec printf("hi CursorLineNr ctermfg=%d  ctermbg=NONE cterm=NONE" , g:selectColor)
    exec printf("hi VertSplit ctermfg=%d  ctermbg=NONE cterm=bold"    , g:backcentColor)
...
fun! g:HandleOtherColors()
    ...
    hi String                        ctermfg=125  ctermbg=NONE cterm=NONE
    ...
    hi Type                          ctermfg=64  ctermbg=NONE cterm=bold
