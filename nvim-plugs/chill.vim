...
" Accent: *{{{1
" Demi is my work computer, kitsune is my home, diff coloschemes
if hostname() == 'demi'
  call s:hy('StatusLine'   , 'none' , '232 ' , 'fg'           , s:xGrey['232'] , 'none'           )
  call s:hy('LineNr'       , '8   ' , '232 ' , s:color8       , s:xGrey['232'] , 'none'           )
  call s:hy('Pmenu'        , '8   ' , '232 ' , s:color8       , s:xGrey['232'] , 'none'           )
  call s:hy('CursorLine'   , 'none' , '233 ' , 'none'         , s:xGrey['233'] , 'none'           )
  call s:hy('CursorLineNr' , 'none' , '233 ' , s:bold         , s:xGrey['233'] , 'bold'           )
  call s:hy('PmenuSbar'    , 'none' , '234 ' , 'none'         , s:xGrey['234'] , 'none'           )
  call s:hy('ColorColumn'  , 'none' , '234 ' , 'none'         , s:xGrey['234'] , 'none'           )
  call s:hy('DiffChange'   , '236 ' , 'none' , s:xGrey['236'] , 'none'         , 'bold,inverse'   )
  call s:hy('Visual'       , 'none' , '235 ' , 'none'         , s:xGrey['235'] , 'bold'           )
  call s:hy('PmenuSel'     , 'none' , '235 ' , s:bold         , s:xGrey['235'] , 'bold'           )
  call s:hy('IncSearch'    , 'none' , '235 ' , s:bold         , s:xGrey['235'] , 'bold,underline' )
  call s:hy('WildMenu'     , 'none' , '236 ' , s:bold         , s:xGrey['236'] , 'bold'           )
  call s:hy('MatchParen'   , 'none' , '236 ' , s:bold         , s:xGrey['236'] , 'bold,underline' )

  call s:hy('User6'        , 'none' , '232'  , 'none'         , s:xGrey['232'] , 'none'           )
  call s:hy('User3'        , 'none' , '233'  , 'none'         , s:xGrey['233'] , 'bold'           )
  call s:hy('User1'        , '2   ' , '233'  , s:color2       , s:xGrey['233'] , 'bold'           )
  call s:hy('User2'        , '1   ' , '233'  , s:color1       , s:xGrey['233'] , 'bold'           )
  call s:hy('User5'        , '7   ' , '233'  , s:color7       , s:xGrey['233'] , 'bold'           )
  call s:hy('User4'        , 'none' , '234'  , 'none'         , s:xGrey['234'] , 'none'           )

  call s:hy('NormalNC'     , 'none' , '233'  , 'none'         , s:bgnc         , 'none'           )
  call s:hy('holdSearch'   , 'none' , '238'  , 'none'         , s:xGrey['238'] , 'none'           )
else
...
" Plugin: X {{{1
call s:hy('Logical0'        , '6'    , '234'  , s:color6  , 'none' , 'bold')
call s:hy('Logical1'        , '5'    , '234'  , s:color5  , 'none' , 'bold')
call s:hy('Logical2'        , '4'    , '234'  , s:color4  , 'none' , 'bold')
call s:hy('Logical3'        , '3'    , '234'  , s:color3  , 'none' , 'bold')
call s:hy('Logical4'        , '2'    , '234'  , s:color2  , 'none' , 'bold')
call s:hy('Logical5'        , '1'    , '234'  , s:color1  , 'none' , 'bold')
call s:hy('Logical6'        , '1'    , '234'  , s:color7  , 'none' , 'bold')
call s:hy('Logical7'        , '2'    , '234'  , s:color8  , 'none' , 'bold')
call s:hy('Logical8'        , '3'    , '234'  , s:color9  , 'none' , 'bold')
call s:hy('Logical9'        , '4'    , '234'  , s:color10 , 'none' , 'bold')
call s:hy('Logical10'       , '5'    , '234'  , s:color11 , 'none' , 'bold')
call s:hy('Logical11'       , '6'    , '234'  , s:color12 , 'none' , 'bold')
