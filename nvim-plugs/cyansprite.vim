...
fun! g:HandleModColor(mod)
    ...
    exec printf("hi TabLineSel   guifg = %s      guibg = %s   gui = reverse"   , g:accentColor       , g:harshAccentColor      )
    exec printf("hi StatusLine   guifg = %s      guibg = %s   gui = reverse"      , g:accentColor       , g:accentBackgroundColor )
