...
hi normal       guifg=#afaabb guibg=#343834 gui=none
hi title        guifg=#dd66dd guibg=none    gui=bold
hi directory    guifg=#aaaa33 guibg=none    gui=bold
...
hi special      guifg=#8acfcf guibg=none    gui=none
...
hi diffadd      guifg=#aaff88 guibg=none    gui=none
hi diffchange   guifg=#88aaff guibg=none    gui=none
hi diffdelete   guifg=#ff88aa guibg=none    gui=none
hi difftext     guifg=#fffcaa guibg=none    gui=none
